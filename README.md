...
tuple.live). Only `site/` is gitignored; `brand/`, `discord/`, `font/`, `CLAUDE.md` and the
rest of `docs/` are tracked here but **not exported to the public repo** (the
export is a whitelist — this sentence said "gitignored" for all of them until
2026-08-18, the same claim CLAUDE.md corrected on 2026-08-05).
